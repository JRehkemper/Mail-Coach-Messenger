...
(function($, window, document) {
  ...
  */
  ...
  var EmojiArea_WYSIWYG = function($textarea, id, options) {
    ...
    this.$editor = $('<div>').addClass('emoji-wysiwyg-editor enterTriggerClass').addClass($($textarea)[0].className);
    ...
    $textarea.after("<i class='emoji-picker-icon emoji-picker " + this.options.popupButtonClasses + "' data-id='" + id + "' data-type='picker' style='width:25px; height:25px; background-color: white; border-radius:20%; padding: 2px; margin-left:1em; position: relative !important;'></i>");
